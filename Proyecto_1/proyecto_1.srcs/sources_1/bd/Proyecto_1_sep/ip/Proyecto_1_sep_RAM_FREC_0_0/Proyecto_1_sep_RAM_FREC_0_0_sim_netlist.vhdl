...
-- Date        : Sat May 11 21:20:04 2024
-- Host        : LAPTOP-H1BP50B7 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/Pato/Desktop/Universida/2024-1/SEP/IEE2463_P1/Proyecto_1/proyecto_1.srcs/sources_1/bd/Proyecto_1_sep/ip/Proyecto_1_sep_RAM_FREC_0_0/Proyecto_1_sep_RAM_FREC_0_0_sim_netlist.vhdl
-- Design      : Proyecto_1_sep_RAM_FREC_0_0
...
entity Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0_S00_AXI : entity is "RAM_FREC_v1_0_S00_AXI";
end Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0_S00_AXI;

architecture STRUCTURE of Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0_S00_AXI is
  ...
  signal \mem_data_out[0][3]_i_2_n_0\ : STD_LOGIC;
...
\mem_data_out[0][3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
      I0 => \mem_data_out[0][3]_i_2_n_0\,
      I1 => s00_axi_wvalid,
      I2 => s00_axi_wstrb(0),
      O => \mem_data_out[0]_0\
    );
\mem_data_out[0][3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => L(4),
      I5 => L(5),
      O => \mem_data_out[0][3]_i_2_n_0\
    );
\mem_data_out_reg[0][0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \mem_data_out[0]_0\,
      D => s00_axi_wdata(0),
      Q => divisor(0),
      R => '0'
    );
\mem_data_out_reg[0][1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \mem_data_out[0]_0\,
      D => s00_axi_wdata(1),
...
\mem_data_out_reg[0][2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \mem_data_out[0]_0\,
      D => s00_axi_wdata(2),
...
\mem_data_out_reg[0][3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \mem_data_out[0]_0\,
      D => s00_axi_wdata(3),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0 : entity is "RAM_FREC_v1_0";
end Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0;

architecture STRUCTURE of Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0 is
begin
RAM_FREC_v1_0_S00_AXI_inst: entity work.Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0_S00_AXI
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proyecto_1_sep_RAM_FREC_0_0 is
  port (
    divisor : out STD_LOGIC_VECTOR ( 3 downto 0 );
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of Proyecto_1_sep_RAM_FREC_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Proyecto_1_sep_RAM_FREC_0_0 : entity is "Proyecto_1_sep_RAM_FREC_0_0,RAM_FREC_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Proyecto_1_sep_RAM_FREC_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of Proyecto_1_sep_RAM_FREC_0_0 : entity is "RAM_FREC_v1_0,Vivado 2020.1";
end Proyecto_1_sep_RAM_FREC_0_0;

architecture STRUCTURE of Proyecto_1_sep_RAM_FREC_0_0 is
...
U0: entity work.Proyecto_1_sep_RAM_FREC_0_0_RAM_FREC_v1_0
     port map (
