...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "LENGTH_MAX"
  ipgui::add_param $IPINST -name "USER_NUM_MEM"

}

proc update_PARAM_VALUE.LENGTH_MAX { PARAM_VALUE.LENGTH_MAX } {
	# Procedure called to update LENGTH_MAX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.LENGTH_MAX { PARAM_VALUE.LENGTH_MAX } {
	# Procedure called to validate LENGTH_MAX
	return true
}

proc update_PARAM_VALUE.USER_NUM_MEM { PARAM_VALUE.USER_NUM_MEM } {
	# Procedure called to update USER_NUM_MEM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.USER_NUM_MEM { PARAM_VALUE.USER_NUM_MEM } {
	# Procedure called to validate USER_NUM_MEM
	return true
}
...
proc update_MODELPARAM_VALUE.LENGTH_MAX { MODELPARAM_VALUE.LENGTH_MAX PARAM_VALUE.LENGTH_MAX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.LENGTH_MAX}] ${MODELPARAM_VALUE.LENGTH_MAX}
}

proc update_MODELPARAM_VALUE.USER_NUM_MEM { MODELPARAM_VALUE.USER_NUM_MEM PARAM_VALUE.USER_NUM_MEM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.USER_NUM_MEM}] ${MODELPARAM_VALUE.USER_NUM_MEM}
}
