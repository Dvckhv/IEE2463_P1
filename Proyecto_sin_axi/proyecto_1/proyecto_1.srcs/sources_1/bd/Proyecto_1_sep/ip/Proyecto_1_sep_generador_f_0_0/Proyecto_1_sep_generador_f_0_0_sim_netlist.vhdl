...
--               Semestre/SEP/Proyecto1/proyecto_1/proyecto_1.srcs/sources_1/bd/Proyecto_1_sep/ip/Proyecto_1_sep_generador_f_0_0/Proyecto_1_sep_generador_f_0_0_sim_netlist.vhdl}
...
entity Proyecto_1_sep_generador_f_0_0_c_Comp_cuadrada is
  port (
  ...
  attribute ORIG_REF_NAME of Proyecto_1_sep_generador_f_0_0_c_Comp_cuadrada : entity is "c_Comp_cuadrada";
end Proyecto_1_sep_generador_f_0_0_c_Comp_cuadrada;

architecture STRUCTURE of Proyecto_1_sep_generador_f_0_0_c_Comp_cuadrada is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proyecto_1_sep_generador_f_0_0_c_Dientes_de_sierra is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proyecto_1_sep_generador_f_0_0_c_Dientes_de_sierra : entity is "c_Dientes_de_sierra";
end Proyecto_1_sep_generador_f_0_0_c_Dientes_de_sierra;

architecture STRUCTURE of Proyecto_1_sep_generador_f_0_0_c_Dientes_de_sierra is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proyecto_1_sep_generador_f_0_0_c_Sinusoide is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proyecto_1_sep_generador_f_0_0_c_Sinusoide : entity is "c_Sinusoide";
end Proyecto_1_sep_generador_f_0_0_c_Sinusoide;

architecture STRUCTURE of Proyecto_1_sep_generador_f_0_0_c_Sinusoide is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proyecto_1_sep_generador_f_0_0_c_Triangular is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proyecto_1_sep_generador_f_0_0_c_Triangular : entity is "c_Triangular";
end Proyecto_1_sep_generador_f_0_0_c_Triangular;

architecture STRUCTURE of Proyecto_1_sep_generador_f_0_0_c_Triangular is
begin
\salida_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Proyecto_1_sep_generador_f_0_0_generador_f is
  port (
    seno_o : out STD_LOGIC_VECTOR ( 7 downto 0 );
    cuadrada_o : out STD_LOGIC_VECTOR ( 0 to 0 );
    triangulada_o : out STD_LOGIC_VECTOR ( 6 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of Proyecto_1_sep_generador_f_0_0_generador_f : entity is "generador_f";
end Proyecto_1_sep_generador_f_0_0_generador_f;

architecture STRUCTURE of Proyecto_1_sep_generador_f_0_0_generador_f is
...
begin
cuadrada_inst: entity work.Proyecto_1_sep_generador_f_0_0_c_Comp_cuadrada
     port map (
...
dientes_inst: entity work.Proyecto_1_sep_generador_f_0_0_c_Dientes_de_sierra
     port map (
...
seno_inst: entity work.Proyecto_1_sep_generador_f_0_0_c_Sinusoide
     port map (
      Q(7 downto 0) => counter(7 downto 0),
      clk_div => clk_div,
      seno_o(7 downto 0) => seno_o(7 downto 0)
    );
triang_inst: entity work.Proyecto_1_sep_generador_f_0_0_c_Triangular
     port map (
      D(6 downto 0) => A(6 downto 0),
      clk_div => clk_div,
...
entity Proyecto_1_sep_generador_f_0_0 is
  ...
  attribute NotValidForBitStream of Proyecto_1_sep_generador_f_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Proyecto_1_sep_generador_f_0_0 : entity is "Proyecto_1_sep_generador_f_0_0,generador_f,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Proyecto_1_sep_generador_f_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Proyecto_1_sep_generador_f_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of Proyecto_1_sep_generador_f_0_0 : entity is "generador_f,Vivado 2020.1";
end Proyecto_1_sep_generador_f_0_0;

architecture STRUCTURE of Proyecto_1_sep_generador_f_0_0 is
...
U0: entity work.Proyecto_1_sep_generador_f_0_0_generador_f
     port map (
      clk_div => clk_div,
      cuadrada_o(0) => \^cuadrada_o\(0),
      referencia(7 downto 0) => referencia(7 downto 0),
