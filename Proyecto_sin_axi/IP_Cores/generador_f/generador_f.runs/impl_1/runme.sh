...
HD_PWD='C:/Users/vicen/OneDrive/Escritorio/Septimo Semestre/SEP/Proyecto1/IP_Cores/generador_f/generador_f.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log generador_f.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source generador_f.tcl -notrace
