...
HD_PWD='C:/Users/vicen/OneDrive/Escritorio/Septimo Semestre/SEP/Proyecto1/IP_Cores/generador_f/generador_f.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log generador_f.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source generador_f.tcl
