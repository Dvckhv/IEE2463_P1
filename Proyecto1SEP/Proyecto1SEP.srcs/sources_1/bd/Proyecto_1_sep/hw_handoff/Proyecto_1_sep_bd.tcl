...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Dientes_de_sierra_0_address [get_bd_pins Dientes_de_sierra_0/address] [get_bd_pins RAM_test_0/address] [get_bd_pins ila_0/probe0]
  connect_bd_net -net RAM_test_0_value [get_bd_pins RAM_test_0/value] [get_bd_pins ila_0/probe1]
  connect_bd_net -net Sel_frec_0_clk_div [get_bd_pins Dientes_de_sierra_0/clk_div] [get_bd_pins RAM_test_0/clk] [get_bd_pins Sel_frec_0/clk_div]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins Sel_frec_0/clk] [get_bd_pins ila_0/clk]
