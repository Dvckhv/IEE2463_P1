...
HD_PWD='C:/Users/vicen/OneDrive/Escritorio/Septimo Semestre/SEP/Proyecto1/Proyecto1SEP/Proyecto1SEP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Proyecto_1_sep_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Proyecto_1_sep_wrapper.tcl
