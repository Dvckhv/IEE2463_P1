...
HD_PWD='C:/Users/vicen/OneDrive/Escritorio/Septimo Semestre/SEP/Proyecto1/Proyecto1SEP/Proyecto1SEP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Proyecto_1_sep_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Proyecto_1_sep_wrapper.tcl -notrace
