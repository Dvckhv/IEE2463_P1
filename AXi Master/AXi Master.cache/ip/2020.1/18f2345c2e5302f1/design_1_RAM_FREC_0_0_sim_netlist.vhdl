...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RAM_FREC_v1_0_S00_AXI is
  port (
    ...
    mem_select : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RAM_FREC_v1_0_S00_AXI is
  ...
  signal NLW_mem_data_out_reg_0_1_0_3_DOC_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal NLW_mem_data_out_reg_0_1_0_3_DOD_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute METHODOLOGY_DRC_VIOS of mem_data_out_reg_0_1_0_3 : label is "";
  attribute RTL_RAM_BITS : integer;
  attribute RTL_RAM_BITS of mem_data_out_reg_0_1_0_3 : label is 8;
  attribute RTL_RAM_NAME : string;
  attribute RTL_RAM_NAME of mem_data_out_reg_0_1_0_3 : label is "U0/RAM_FREC_v1_0_S00_AXI_inst/mem_data_out";
  attribute RTL_RAM_TYPE : string;
  attribute RTL_RAM_TYPE of mem_data_out_reg_0_1_0_3 : label is "RAM_SDP";
  attribute ram_addr_begin : integer;
  attribute ram_addr_begin of mem_data_out_reg_0_1_0_3 : label is 0;
  attribute ram_addr_end : integer;
  attribute ram_addr_end of mem_data_out_reg_0_1_0_3 : label is 1;
  attribute ram_offset : integer;
  attribute ram_offset of mem_data_out_reg_0_1_0_3 : label is 0;
  attribute ram_slice_begin : integer;
  attribute ram_slice_begin of mem_data_out_reg_0_1_0_3 : label is 0;
  attribute ram_slice_end : integer;
  attribute ram_slice_end of mem_data_out_reg_0_1_0_3 : label is 3;
begin
...
mem_data_out_reg_0_1_0_3: unisim.vcomponents.RAM32M
     port map (
      ADDRA(4 downto 1) => B"0000",
      ADDRA(0) => mem_select(0),
      ADDRB(4 downto 1) => B"0000",
      ADDRB(0) => mem_select(0),
      ADDRC(4 downto 1) => B"0000",
      ADDRC(0) => mem_select(0),
      ...
      DIC(1 downto 0) => B"00",
      DID(1 downto 0) => B"00",
      DOA(1 downto 0) => divisor(1 downto 0),
      DOB(1 downto 0) => divisor(3 downto 2),
      DOC(1 downto 0) => NLW_mem_data_out_reg_0_1_0_3_DOC_UNCONNECTED(1 downto 0),
      DOD(1 downto 0) => NLW_mem_data_out_reg_0_1_0_3_DOD_UNCONNECTED(1 downto 0),
      WCLK => s00_axi_aclk,
      WE => p_0_in11_out
    );
mem_data_out_reg_0_1_0_3_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
mem_data_out_reg_0_1_0_3_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
